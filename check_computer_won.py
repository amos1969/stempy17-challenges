...
print("Data - computer_hand = R, and user_hand = S, expected True. Actual result ->", check_if_computer_wins("R","S"))
print("Data - computer_hand = R, and user_hand = P, expected False. Actual result ->", check_if_computer_wins("R","P"))
print("Data - computer_hand = R, and user_hand = R, expected False. Actual result ->", check_if_computer_wins("R","R"))